      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col">
        <header className="flex items-center justify-between border-b border-slate-200/80 pb-5">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="hidden rounded-xl px-4 py-2 text-sm font-bold text-slate-700 hover:bg-white sm:inline-flex"
            >
              Sign in
            </Link>
            <Link
              href="/register"
              className="inline-flex min-h-10 items-center rounded-xl bg-emerald-800 px-4 text-sm font-bold text-white hover:bg-emerald-900"
            >
              Register
            </Link>
          </div>
        ...
        <section className="grid flex-1 items-center gap-12 py-16 lg:grid-cols-[1.15fr_0.85fr] lg:py-24">
          <div>
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600 sm:text-xl">
              LoanTrack NG brings borrower registration, loan requests,
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <Link
                href="/register"
                className="inline-flex min-h-12 items-center rounded-xl bg-emerald-800 px-6 font-bold text-white shadow-sm hover:bg-emerald-900"
              >
                Create borrower account
              </Link>
              <Link
                href="/login"
                className="inline-flex min-h-12 items-center rounded-xl border border-slate-300 bg-white px-6 font-bold text-slate-800 hover:border-slate-400"
              >
                Sign in
              </Link>
            </div>
